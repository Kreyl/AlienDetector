...
public:
    LedSmooth_t(const PwmSetup_t APinSetup) : BaseSequencer_t(), IChnl(APinSetup), ICurrentBrightness(0) {}
    LedSmooth_t(const LPTimPwmSetup_t APinSetup) : BaseSequencer_t(), IChnl(APinSetup), ICurrentBrightness(0) {}
